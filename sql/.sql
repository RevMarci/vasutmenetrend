...
Insert into C##Y7BRWS.ADMIN (EMAIL,JELSZO,NEV,ADMIN_ID) values ('admin2@vasut.hu','SzuperTitkosJelszo002!','Adminisztrátor Második','2');
...
Insert into C##Y7BRWS.ALLOMAS (ID,NEV,HELY) values ('2','Gyulai Városerdő','Gyula');
REM INSERTING into C##Y7BRWS.JARAT
SET DEFINE OFF;
Insert into C##Y7BRWS.JARAT (JARATSZAM,TIPUS,SZERELVENY_MOZDONYSZAM) values ('2','Szemely','222222');
...
SET DEFINE OFF;
Insert into C##Y7BRWS.SZERELVENY (MOZDONYSZAM,KAPACITAS) values ('222222','200');
Insert into C##Y7BRWS.SZERELVENY (MOZDONYSZAM,KAPACITAS) values ('111111','1000');
REM INSERTING into C##Y7BRWS.TAG
SET DEFINE OFF;
Insert into C##Y7BRWS.TAG (EMAIL,JELSZO,NEV) values ('kiss.janos@gmail.com','SzuperTitkosJelszo001!','Kiss János');
...
Insert into C##Y7BRWS.TAG (EMAIL,JELSZO,NEV) values ('nemet.judit@gmail.com','SzuperTitkosJelszo010!','Német Judit');
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##Y7BRWS"."JARAT" ADD CONSTRAINT "JARAT_FK_MOZDONYSZAM" FOREIGN KEY ("SZERELVENY_MOZDONYSZAM")
	  REFERENCES "C##Y7BRWS"."SZERELVENY" ("MOZDONYSZAM") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##Y7BRWS"."JEGY" ADD CONSTRAINT "JEGY_FK_KEDVEZMENY" FOREIGN KEY ("KEDVEZMENYEK_ID")
	  REFERENCES "C##Y7BRWS"."KEDVEZMENY" ("ID") ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##Y7BRWS"."MEGALL" ADD CONSTRAINT "MEGALL_FK_ALLOMAS" FOREIGN KEY ("ALLOMAS_ID")
	  REFERENCES "C##Y7BRWS"."ALLOMAS" ("ID") ENABLE;
